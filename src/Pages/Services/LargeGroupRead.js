      ...
      <Grid item sm={11} xs={11} md={7} lg={5}>
       <Card className={classes.root}>
        ...
        <MuiThemeProvider theme={theme}>                          
         <Typography variant="h4" gutterBottom className={classes.title}> Demonstrations (20+ people)<Typography variant="h5" className={classes.price} gutterBottom>price: $80+</Typography>
