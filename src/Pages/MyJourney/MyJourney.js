         ...
         <Grid className={classes.grid} container justify="center" alignItems="center" direction="row" spacing={3}>
          ...
          <Grid item sm={12} xs={12} md={5} lg={5}>  
           <Grid container direction="column">   
             <Typography className={classes.text} body="1">My spiritual journey began in 2013. Though I’ve been sensitive to Spirit since I was a child, it was only after marriage, children and a career that my mediumship started to unfold. When you get to a point where Spirit is whispering in your ear telling you, “It’s Time!” and the universe starts sending you messages, I figured I should begin listening. My awareness to spirits as well as people’s emotions or thoughts (even the ones they didn’t know for themselves) sent me searching for answers.  I started reading everything relevant that I could get my hands on sending me on the most amazing and exciting journey ever!</Typography>
           </Grid>
          </Grid>
          ...
          <Grid item sm={12} xs={12} md={5} lg={5}>  
           <Grid container direction="column">
             <Typography className={classes.text} body="1">I have many amazing experiences with Spirits and the spirit world. More than I can count. I can honestly say, it’s such a blessing for me to be able to communicate with the world of Spirit. When I was twelve, I Was woken from my sleep. Believe it or not, I was having a conversation with my guardian angel Zachariah… Yes, it is true. Believe it or not, but it is true... He told me about the little girl I was going to have, and he even showed me what she would look like. He explained to me that she would bring so much love into my life. I’ve also had the experience of traveling to the other side with my uncle Ralph, my mom’s brother whom I adore so very much. Back then, I always asked the spirit world to show me what the other side was like. I guess they got tired of me asking because in the night not long after my uncle died, I got a visit from him. He told me he was taking me on an adventure and showed me what it was like on the other side. It was the most beautiful experience I have ever encountered. I didn't want to come back. My uncle assured me there would be more opportunities for me in the future and he was right. I’ve had and continue to have many more amazing occurrences.</Typography>
           </Grid>
          </Grid>

          <Grid item sm={12} xs={12} md={10} lg={10}>
              <Typography className={classes.text} body="1">The most challenging experience for me was when my friend from High School passed away of cancer in her forties. Even though we lived provinces apart we always kept in touch. Her death was very difficult for me. She was the most caring and loving friend I knew. The great gift I got from her is when she came to visit me before she died. I cherish the time I had with her then and treasure the memories we shared even more now. She continues to always and be around me whenever I need her most.</Typography>
          </Grid>

          <Grid item sm={12} xs={12} md={10} lg={10}>
              <Typography className={classes.text} body="1">I always felt and knew that life continued after death. I can’t explain why, but I always had a knowing...It took many years until I was in my forties that I had to do something... I spent years hiding my gifts and afraid to speak to anyone about them because I was afraid people would think I was a lunatic.</Typography>
          </Grid>
          ...
          <Grid item sm={12} xs={12} md={10} lg={10}>
              <Typography className={classes.ending} body="1">Today I continue to facilitate and volunteer my time between two Spiritual Churches. In addition, I volunteer to do platforms, message services, demonstrations, mini readings and special events whilst participating in weekly mediumship circles. While there are a few different forms of mediumship, I work as a mental medium, which means I communicate with spirits through the use of telepathy. Spirits impress my mind and body with thoughts and feelings that come in the form of "clairs." I mentally "hear" (clairaudience), "see" (clairvoyance), "know" (claircognizance) and/or "feel" (clairsentience) messages from spirits.  This work allows me to be a voice and a conduit of the spirit world, and it brings me great joy to help others heal while bringing relief and comfort to everyone I connect with.</Typography>
          </Grid>
