...
import { Box, Button, Grid, Typography, createMuiTheme, MuiThemeProvider, responsiveFontSizes, CardMedia, Card, Container } from '@material-ui/core';
...
const Footer = () => {
    ...
    return (
        ...
        <Grid className={classes.root} container spacing={5}>
          ...
          <Grid className={classes.gridItem1} item sm={3} xs={12} md={4} lg={4}>
          ...
          <Grid className={classes.gridItem2} item sm={3} xs={12} md={4} lg={4}>
               <Box borderBottom={1}>Follow Me</Box>
               <Box className={classes.box}><a className={classes.link} href="https://www.instagram.com/spiritualmediumclaudiaremy/" target="_blank">Instagram</a></Box>
               <Box className={classes.box}><a className={classes.link} href="https://www.facebook.com/claudialisa.remy" target="_blank">Facebook</a></Box>
          </Grid>
